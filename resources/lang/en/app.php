...
return [
    ...
    */
    ...
    'dashboard' => [
        ...
        'payment' => 'Payment',
        'table' => [
            'po_status_timeframe' => 'PO Status Timeframe',
            'po_status' => 'PO Status',
            ...
            'qty' => 'Quantity',
            'avg_selling_qty' => 'Avg Selling (Qty)',
            ...
            'log_stock_movement' => 'Log Stock Movement',
            'date_order' => 'Date Order',
            'username' => 'Username',
            'hospital_name' => 'Hospital Name',
            'no_po_ref' => 'No PO Ref',
            'status' => 'status',
            'log_activity_order' => 'Log Activity Order',
            'name' => 'Name',
            ...
            'top_worst_product' => 'Top Worst Product', 
    ...
    'shop_account_number' => 'Account number of this shop',
    ...
    'shipping_method_type' => [
        'manual' => [
            ...
            'description' => 'Offer customers manually set shipping options with instructions.',
            'admin_description' => 'Enabling manually set shipping options will allow vendors to set their shipping zone, carrier, shipping charge etc manually',
        ],
        'online' => [
            'name' => 'Online shipping options',
            'description' => 'Offer customers automated shipping options and charges.',
            'admin_description' => 'Enabling online shipping options will allow vendors to automate their shipping process, including automatically assigning carriers , getting shipping cost, scheduling shipments etc.',
        ],
    ],
    ...
    'select_client_group' => 'Select Client Group',
    'category_group' => 'Category Group',
    'select_category_group' => 'Select Category Group',
    'select_category_sub_group' => 'Select Category Sub-group',
    'username' => 'Username',
    'user_name' => 'Username',
    'product_name' => 'Product Name',
    'timeframe_filters' => 'Timeframe Filter',
    'interval' => 'Interval',
    'select_timeframe_type' => 'Select Timeframe Type',
    'daily' => 'Daily',
