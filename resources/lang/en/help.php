...
return [
    ...
    |
    */
    'custom_css_help_text' => 'Add your custom styling CSS in the box. This will override the theme design.',

    'custom_css_guideline_for_merchant' => 'Easily customize the appearance of your profile page by applying your own custom CSS styles. Adjust the color of your shop name and resize your logo effortlessly using the following steps.',

    'custom_css_guideline' => 'Easily customize the appearance of your marketplace by applying your own custom CSS styles. If you want to change the main navigation bar\'s bankground color and search button and footer\'s, this is how you can do that.',

    'trust_badge_size' => 'Trust badge image size should be 32x32px and .png',
    ...
    'top_bar_img_size'  => 'Top bar image size should be 90x1500',
    ...
    'available_from' => 'The date when the stock will be available. A delay can happen when the server time is different than your local time.',
    ...
    'shipping_length' => 'Products length used by shipping services for shipping cost',

    'shipping_width' => 'Product width used by shipping services for shipping cost',

    'shipping_height' => 'Product height used by shipping services for shipping cost',
    ...
    'slider_img_hint' => 'The slider image should be 1440x350px',

    'slider_img_hint_made_in_china' => 'The slider image should be 780x400px',
    ...
    'uninstall_license_incevio' => 'Before uninstalling the license from your system, you need to delete the installion from incevio.com self support portal.',
    ...
    'shop_account_number' => 'Enter bank account number here this account will show to admin when you will request for payment',
