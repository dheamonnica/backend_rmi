...
return [
    ...
    */
    ...
    'youe_shop_in_maintenance_mode' => 'The shop is in maintenance mode.',
    ...
    'clear_demo_contents' => 'Clearing demo contents will remove all demo data from the database. The system will go back to a fresh installation. <br/><b>You can\'t revert this action.</b>',
    ...
    'empty_state_message' => 'State can not be empty select at leas one',
