    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <fieldset>
          ...
          @if (isset($product) && $product->inventories->count())
            <fieldset>
              <legend>
                {{ trans('app.variants') }}
          ...
          @else
            <div id="myAttributes" class="py-5 mb-5">
              <div id="attributesFieldset" class="mb-5">
                <h4 class="text-center text-muted">{!! trans('help.select_category') !!}</h4>
              </div>

              <div id="set-variant-btn-block" class="text-center hide">
                <p class="mb-3">{!! trans('help.choose_attributes') !!}</p>

                <button class="btn btn-default btn-lg" id="setCombinations">{{ trans('app.set_variants') }}</button>
              </div>
            </div>
          @endif
        </fieldset>
      ...
      <div class="box-body">
        ...
        <fieldset>
          ...
          <fieldset id="form_shipping_section" class="form_shipping_section">
            ...
            <div class="form-group">
              {!! Form::label('length', trans('app.form.length'), ['class' => 'with-help']) !!}
              <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('help.shipping_length') }}"></i>
              {!! Form::text('length', null, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.shipping_length')]) !!}
            </div>
            ...
            <div class="form-group">
              ...
              {!! Form::text('width', null, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.shipping_width')]) !!}
            </div>
            ...
            <div class="form-group">
              ...
              {!! Form::text('height', null, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.shipping_height')]) !!}
            </div>
    
            <div class="form-group">
              {!! Form::label('distance_unit', trans('app.form.distance_unit'), ['class' => 'with-help']) !!}
              {!! Form::select('distance_unit', ['cm' => 'Centimeter', 'm' => 'Meter'], 'cm', ['class' => 'form-control select2-normal', 'placeholder' => trans('app.placeholder.distance_unit')]) !!}
            </div>
          ...
          {{--              @include('admin.product._attribute_dropdown', ['attributes' => $attributes]) --}}
          {{--            @endif --}}
          {{--          </fieldset> --}}
