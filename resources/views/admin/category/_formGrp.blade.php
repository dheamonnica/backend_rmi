...
<div class="row">
  <div class="col-md-4 nopadding-right" style="display: none">
    <div class="form-group">
...
{{-- <div class="row">
  <div class="col-md-4 nopadding-right">
    <div class="form-group">
      ...
      @if (isset($categoryGroup) && $categoryGroup->backgroundImage)
        <label>
  ...
  <div class="col-md-4 nopadding-left nopadding-right">
    <div class="form-group">
      ...
      @if (isset($categoryGroup) && $categoryGroup->coverImage)
        <label>
  ...
  <div class="col-md-4 nopadding-left">
    <div class="form-group">
      ...
      @if (isset($categoryGroup) && $categoryGroup->logoImage)
        <label>
