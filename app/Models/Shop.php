...
{
    use HasFactory, SoftDeletes, HasHumanAttributes, Loggable, Notifiable, Addressable, Imageable, Feedbackable, Billable;
    ...
    {
        return $this->hasMany(\Incevio\Package\Packaging\Models\Packaging::class)->where('active', 1);
    }
    ...
    {
        return $this->hasOne(\Incevio\Package\Packaging\Models\Packaging::class)->where('default', 1)->withDefault();
    }
