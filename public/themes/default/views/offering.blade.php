        ...
        <div class="container container-custom">
            <div class="row">
                <div class="col-md-7 col-lg-8">
                    ...
                    <a href="#" class="btn btn-primary mt-4">READMORE</a>
                </div>
                <div class="col-md-5 col-lg-4">
                    <div class="booking-form-style5">
                        <form action="#">
                            <h3>Offering</h3>
                            <!--<div class="form-group form-group-cutom2">
                            <input type="text" class="form-control form-custom" placeholder="">
                            <i class=""></i>
                        </div>-->
                            <br>
                            <div class="form-group form-group-cutom">
                                <input type="text" class="form-control form-custom" placeholder="Company Name">
                                <i class="far fa-building"></i>
                            </div>
                            <div class="form-group form-group-cutom">
                                <input type="text" class="form-control form-custom" placeholder="Enter Your Name">
                                <i class="far fa-user"></i>
                            </div>
                            <div class="form-group form-group-cutom">
                                <input type="number" class="form-control form-custom" placeholder="Phone number">
                            ...
                            <!-- <div class="form-group form-group-cutom">
                            <input type="text" class="form-control form-custom" placeholder="Location Manifactur Country">
                            <i class="fas fa-map-marker-alt"></i>
                        </div> -->
                            <div class="form-group form-group-cutom">
                                <select id="country" name="country" class="form-control"
                                    placeholder="Location Manifactur Country">
                                    <option selected>Location Manifactur Country</option>
                            ...
                            <div class="form-group form-group-cutom">
                                <select class="custom-select" id="inputGroupSelect01">
                                    <option selected>Select a Offer Quantity Pcs</option>
                            ...
                            <div class="form-group form-group-cutom">
                                <input type="text" class="form-control form-custom"
                                    placeholder="Enter Best Price in $">
                                <i class="fas fa-tags"></i>
                            </div>
                            <a href="#" class="btn btn-success w-100">Send Offering</a>
                        </form>
                        <div class="booking-bg">
                            <img src="/front/images/form-bg.png" class="img-fluid" alt="#">
                        </div>
                    </div>
                </div>
            </div>
